                    ...
                    <div className="px-6 py-4">
                        <div className="relative mb-4">
                            <input
                                type="search"
                                placeholder="Search for products..."
                                className={`w-full pl-10 pr-4 py-2 rounded-full ${isDarkMode ? 'bg-[#111] text-white placeholder:text-gray-400' : 'bg-gray-100 text-gray-900 placeholder:text-gray-500'
                                    }`}
                            />
                            <MagnifyingGlassIcon className={`w-5 h-5 absolute left-3 top-1/2 -translate-y-1/2 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                        </div>
